(function () {
    ...
    var copyButtons = [
        document.getElementById("copy-install-primary"),
        document.getElementById("copy-install-inline")
    ].filter(Boolean);
    ...
    function copyInstallPrompt(button) {
        var value = prompt.textContent.trim();
        var done = function () {
